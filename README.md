...
## Technical Stack
- **Languages & Libraries:** Python, NumPy, Pandas, Matplotlib, PySwarms, SciPy, pgmpy  
...
- PSO achieved an approximate optimum of `f(x*) ≈ -16.99999` at `(x₁, x₂) = (2, 3)`, closely matching the LP’s exact solution.  
- Constructed a **Bayesian Network** to perform both **exact** and **approximate inference**, analyzing how graph structure affects runtime.  
- Evaluated the trade-offs between model transparency, computational cost, and flexibility.

## Insights
- Preprocessing had minimal impact on runtime due to limited outlier presence but showed the importance of scalable cleaning pipelines.  
- Linear programming provided **deterministic precision** and efficiency for convex problems.  
- Particle Swarm Optimization excelled in **nonlinear or derivative-free search spaces**, albeit at higher computational cost.  
...
- Explore real-world use cases such as clinical decision support or resource allocation.
